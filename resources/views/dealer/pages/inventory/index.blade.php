...
@push('page-assets')
    ...
    @vite(['resources/css/dealer/pages/inventory.css', 'resources/js/dealer/pages/inventory.js'])
@endpush
                    ...
                    <div class="inv-filter-group open" data-group="location">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($availableLocations as $loc)
                                @php
                                    $locCount = \App\Models\Inventory\Vehicle::withoutGlobalScope(
                                        \App\Models\Scopes\LocationScope::class,
                                    )
                                        ->forDealer($dealer->id)
                                ...
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="location"
                                        value="{{ $loc->id }}"
                    ...
                    <div class="inv-filter-group open" data-group="condition">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($conditionCounts as $cond => $count)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="condition"
                                        value="{{ $cond }}" {{ request('condition') === $cond ? 'checked' : '' }}>
                                    {{ $cond }}
                        ...
                        <div class="inv-filter-body">
                            <div class="inv-filter-scroll">
                                @foreach ($makeCounts as $make)
                                    <label class="inv-filter-item">
                                        <input type="checkbox" class="inv-filter-cb" data-filter="make_id"
                                            value="{{ $make->id }}"
                    ...
                    <div class="inv-filter-group" data-group="body">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($bodyTypeCounts as $bodyName => $count)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="body_type_id"
                                        value="{{ $bodyName }}">
                                    {{ $bodyName }}
                                    <span class="inv-filter-count">({{ $count }})</span>
                                </label>
                    ...
                    <div class="inv-filter-group" data-group="extcolor">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($exteriorColorCounts as $color)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="exterior_color_id"
                                        value="{{ $color->id }}"
                    ...
                    <div class="inv-filter-group" data-group="intcolor">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($interiorColorCounts as $color)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="interior_color_id"
                                        value="{{ $color->id }}"
                    ...
                    <div class="inv-filter-group" data-group="fuel">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($fuelTypeCounts as $fuel)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="fuel_type_id"
                                        value="{{ $fuel->id }}"
                    ...
                    <div class="inv-filter-group" data-group="trans">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($transmissionCounts as $trans)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="transmission_type_id"
                                        value="{{ $trans->id }}"
                    ...
                    <div class="inv-filter-group" data-group="drive">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($drivetrainCounts as $drive)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="drivetrain_type_id"
                                        value="{{ $drive->id }}"
                    ...
                    <div class="inv-filter-group" data-group="seats">
                        ...
                        <div class="inv-filter-body">
                            @foreach ($seatingCounts as $seats => $count)
                                <label class="inv-filter-item">
                                    <input type="checkbox" class="inv-filter-cb" data-filter="seating_capacity"
                                        value="{{ $seats }}"
                ...
                <div class="inv-content">
                    ...
                    <div class="inv-topbar">
                        ...
                        <a href="{{ route('dealer.inventory.index', array_merge(request()->except('on_hold', 'status'), ['on_hold' => 1])) }}"
                            class="inv-btn-tab {{ request('on_hold') ? 'active' : '' }}" id="tabOnHold">
                            On-Hold
                        </a>
                        <a href="{{ route('dealer.inventory.index', array_merge(request()->except('on_hold', 'status'), ['status' => 'sold'])) }}"
                            class="inv-btn-tab {{ request('status') === 'sold' ? 'active' : '' }}" id="tabTempSold">
                            Temp. Sold
                        </a>
                        ...
                        <div class="inv-topbar-right">
                            ...
                            <div class="inv-cols-wrap">
                                ...
                                <div class="inv-cols-dropdown" id="colsDropdown">
                                    ...
                                    <label class="inv-col-item">
                                        <input type="checkbox" class="col-toggle" data-col="override" checked> Status
                                        Override
                                    </label>
                                    <label class="inv-col-item">
                                        ...
                                        <tr>
                                            ...
                                            <td class="inv-thumb-cell">
                                                @if ($vehicle->primaryPhoto)
                                                    <img class="inv-thumb" src="{{ $vehicle->primaryPhoto->url }}"
                                            ...
                                            <td>
                                                <a href="{{ route('dealer.inventory.vdp.show', $vehicle) }}"
                                                    ...
                                                    <span
                                                        class="inv-veh-desktop">{{ strtoupper($vehicle->display_title) }}</span>
                                                    <span
                                                        class="inv-veh-mobile">{{ \Illuminate\Support\Str::limit($vehicle->display_title, 10) }}<br><small>({{ $vehicle->stock_number }})</small></span>
                                                </a>
                                            </td>
                                            ...
                                            <td class="col-td" data-col="status">
                                                ...
                                                @else
                                                    <span
                                                        class="inv-badge-draft">{{ strtoupper($vehicle->status) }}</span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="col-td" data-col="price">
                                                <span class="inv-price-display">
                                                    ...
                                                    <i class="bi bi-pencil-square inv-price-edit" title="Edit price"
                                                ...
                                                <span class="inv-price-editor">
                                                    ...
                                                    <input type="text" class="inv-price-input"
                                            ...
                                            <td class="col-td" data-col="days">
                                                <span
                                                    class="inv-days-badge {{ $vehicle->days_on_lot > 90 ? 'inv-days-old' : '' }}">
                                                    {{ $vehicle->days_on_lot }}
                                                </span>
                                            </td>
                                            ...
                                            <td class="col-td" data-col="cost" style="display:none;">
                                                {{ $vehicle->prices?->dealer_cost ? '$' . number_format($vehicle->prices->dealer_cost) : '—' }}
                                            </td>
                                        ...
                                        <div class="inv-grid-body">
                                            ...
                                            <div class="inv-grid-meta">
                                                ...
                                                <span><i class="bi bi-currency-dollar"></i>
                                                    {{ $vehicle->list_price ? number_format($vehicle->list_price) : '—' }}</span>
                                                <span><i class="bi bi-speedometer2"></i>
                                                    {{ $vehicle->mileage ? number_format($vehicle->mileage) : '—' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
