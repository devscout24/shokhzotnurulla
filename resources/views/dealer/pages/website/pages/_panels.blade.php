...
<div class="hs-actions">
    <button type="button" class="btn btn-danger btn-sm flex-1 fw-bold" onclick="closeAllPanels()" style="background:purple; border-radius:8px; padding:10px; flex:1">Apply Changes</button>
...
<hr class="hs-divider"/>
<div class="hs-actions">
    <button type="button" class="btn btn-danger btn-sm flex-1 fw-bold" id="is-apply-btn" style="background:purple; border-radius:8px; padding:10px; flex:1">Apply Changes</button>
...
<hr class="hs-divider"/>
<div class="hs-actions">
    <button type="button" class="btn btn-danger btn-sm flex-1 fw-bold" id="vs-apply-btn" style="background:purple; border-radius:8px; padding:10px; flex:1">Apply Changes</button>
