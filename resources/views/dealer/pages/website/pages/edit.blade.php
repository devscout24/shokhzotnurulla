...
<button type="button" class="btn btn-outline-secondary btn-sm px-4 fw-bold border-2" style="border-radius:6px"><i class="fa-solid fa-eye me-2"></i>Preview</button>
<button type="button" class="btn btn-outline-secondary btn-sm px-4 fw-bold border-2" style="border-radius:6px" onclick="toggleSidePanel('page-settings')"><i class="fa-solid fa-gear me-2"></i>Page Settings</button>
<button type="button" class="btn btn-outline-secondary btn-sm px-4 fw-bold border-2" style="border-radius:6px" onclick="toggleSidePanel('page-revisions')"><i class="fa-solid fa-clock-rotate-left me-2"></i>Page Revisions</button>
<button type="submit" class="btn btn-danger btn-sm px-5 fw-bold shadow-sm" style="background:#ce4f4b; border-radius:6px"><i class="fa-solid fa-check me-2"></i>Update</button>
</div>
</div>
...
<div class="fw-bold bg-lighter card-header d-flex justify-content-between align-items-center py-3 border-0" style="background:transparent">
<span class="small text-muted text-uppercase fw-bolder" style="letter-spacing:1px">Document</span>
<div class="d-flex align-items-center gap-2">
<div class="btn-group bg-white border shadow-sm" style="border-radius:6px; overflow:hidden">
<button type="button" class="btn btn-light btn-sm border-end px-3" id="btn-undo"><i class="fa-solid fa-rotate-left"></i></button>
<button type="button" class="btn btn-light btn-sm px-3" id="btn-redo"><i class="fa-solid fa-rotate-right text-primary"></i></button>
</div>
</div>
</div>
<div class="p-0">
...
<div class="sidebar-content-area" id="sidebar-add-content">
    ...
    <div id="sidebar-default-content">
        ...
        <div class="block-grid">
            ...
            <div class="block-item" draggable="true" data-type="map"><i class="fa-solid fa-location-dot"></i><span>Map</span></div>
    ...
    <div class="side-panel-body">
        ...
        <div class="hs-row">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ url($page->slug) }}" target="_blank" class="btn btn-outline-secondary d-flex align-items-center" title="View Page">
