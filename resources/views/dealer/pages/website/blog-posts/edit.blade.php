...
@push('page-assets')
    ...
    <style>
        ...
        .drag-over {
            background-color: rgba(128, 0, 128, 0.02) !important;
    ...
    <div class="of-master-frame">
        <form action="{{ route('dealer.website.blog-posts.update', $blogPost->id) }}" method="POST" id="page-builder-form"
            ...
            <div class="of-header shadow-sm">
                <h4 class="m-0 fs-5 text-dark">Edit Blog Post</h4>
                <div class="ms-auto d-flex align-items-center gap-3">
                    ...
                    <button type="submit" class="btn btn-danger btn-sm px-4"
                        style="border-radius:6px;background-color:purple;border-color:purple"><i class="fa-solid fa-check me-2"></i>Update</button>
                </div>
            </div>
            ...
            <div class="d-flex flex-grow-1 overflow-hidden">
                <div class="canvas-left flex-grow-1">
                ...
                <div class="sidebar-right">
                    <div class="sidebar-tabs">
                        <div class="sidebar-tab active" data-tab="add">Add Block</div>
                        <div class="sidebar-tab" data-tab="edit">Edit Block</div>
                    </div>
                    <div class="sidebar-content-area" id="sidebar-add-content">
                        @include('dealer.pages.website.pages._panels')
                        <div id="sidebar-default-content">
                            <div class="section-title">Layout</div>
                            <div class="block-grid">
                                <div class="block-item" draggable="true" data-type="container"><i
                                        class="fa-solid fa-square-poll-horizontal"></i><span>Container</span></div>
                                <div class="block-item" draggable="true" data-type="2col"><i
                                        class="fa-solid fa-columns"></i><span>2-Col</span></div>
                                <div class="block-item" draggable="true" data-type="3col"><i
                                        class="fa-solid fa-table-columns"></i><span>3-Col</span></div>
                                <div class="block-item" draggable="true" data-type="overlay"><i
                                        class="fa-solid fa-clone"></i><span>Overlay</span></div>
                                <div class="block-item" draggable="true" data-type="html"><i
                                        class="fa-solid fa-code"></i><span>HTML</span></div>
                                <div class="block-item" draggable="true" data-type="css"><i
                                        class="fa-solid fa-terminal"></i><span>CSS</span></div>
                            </div>
                            <div class="section-title">Content</div>
                            <div class="block-grid">
                                <div class="block-item" draggable="true" data-type="span"><i
                                        class="fa-solid fa-quote-left"></i><span>Span</span></div>
                                <div class="block-item" draggable="true" data-type="heading"><i
                                        class="fa-solid fa-heading"></i><span>Heading</span></div>
                                <div class="block-item" draggable="true" data-type="text"><i
                                        class="fa-solid fa-align-left"></i><span>Text</span></div>
                                <div class="block-item" draggable="true" data-type="button"><i
                                        class="fa-solid fa-toggle-on"></i><span>Button</span></div>
                                <div class="block-item" draggable="true" data-type="divider"><i
                                        class="fa-solid fa-minus"></i><span>Divider</span></div>
                                <div class="block-item" draggable="true" data-type="image"><i
                                        class="fa-solid fa-image"></i><span>Image</span></div>
                                <div class="block-item" draggable="true" data-type="video"><i
                                        class="fa-solid fa-video"></i><span>Video</span></div>
                                <div class="block-item" draggable="true" data-type="carousel"><i
                                        class="fa-solid fa-images"></i><span>Carousel</span></div>
                                <div class="block-item" draggable="true" data-type="accordion"><i
                                        class="fa-solid fa-list"></i><span>Accordion</span></div>
                                <div class="block-item" draggable="true" data-type="spacer"><i
                                        class="fa-solid fa-arrows-up-down"></i><span>Spacer</span></div>
                                <div class="block-item" draggable="true" data-type="icon"><i
                                        class="fa-solid fa-icons"></i><span>Icon</span></div>
                                <div class="block-item" draggable="true" data-type="cart"><i
                                        class="fa-solid fa-cart-shopping"></i><span>Cart</span></div>
                                <div class="block-item" draggable="true" data-type="iframe"><i
                                        class="fa-solid fa-window-maximize"></i><span>iFrame</span></div>
                                <div class="block-item" draggable="true" data-type="card"><i
                                        class="fa-solid fa-id-card"></i><span>Card</span></div>
                            </div>
                            <div class="section-title">Overfuel Blocks</div>
                            <div class="block-grid">
                                <div class="block-item" draggable="true" data-type="inventory"><i
                                        class="fa-solid fa-car-side"></i><span>Inventory</span></div>
                                <div class="block-item" draggable="true" data-type="search"><i
                                        class="fa-solid fa-magnifying-glass"></i><span>Search</span></div>
                                <div class="block-item" draggable="true" data-type="form"><i
                                        class="fa-solid fa-file-invoice"></i><span>Form</span></div>
                                <div class="block-item" draggable="true" data-type="blog"><i
                                        class="fa-solid fa-newspaper"></i><span>Blog Posts</span></div>
                                <div class="block-item" draggable="true" data-type="content_block"><i
                                        class="fa-solid fa-cubes"></i><span>Content Block</span></div>
                                <div class="block-item" draggable="true" data-type="body_types"><i
                                        class="fa-solid fa-truck-pickup"></i><span>Body Types</span></div>
                                <div class="block-item" draggable="true" data-type="map_hours"><i
                                        class="fa-solid fa-clock"></i><span>Map / Hours</span></div>
                                <div class="block-item" draggable="true" data-type="map"><i
                                        class="fa-solid fa-location-dot"></i><span>Map</span></div>
                                <div class="block-item" draggable="true" data-type="plugin"><i
                                        class="fa-solid fa-plug"></i><span>Plugin</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="side-panel" id="side-panel-page-settings">
                ...
                <div class="side-panel-footer">
                    <button type="button" class="btn btn-danger w-100 fw-bold" onclick="toggleSidePanel('page-settings')"
                        style="background:purple">Apply Settings</button>
                </div>
            </div>
