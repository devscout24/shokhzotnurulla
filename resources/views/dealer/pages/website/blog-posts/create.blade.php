    ...
    <div class="of-master-frame">
        <form action="{{ $routes['store'] }}" method="POST" id="page-builder-form" style="display:contents"
            ...
            <div class="of-header shadow-sm">
                <h4 class="m-0 fs-5 text-dark">Add Blog Post</h4>
                <div class="ms-auto d-flex align-items-center gap-3">
                    ...
                    <button type="submit" class="btn btn-danger btn-sm px-4"
                        style="border-radius:6px;background-color:purple;border-color:purple"><i class="fa-solid fa-check me-2"></i>Save</button>
                </div>
            </div>
