                        ...
                        <div class="rc-main-container" style="border: 1px solid #e0e0e0; border-radius: 8px;">
                            ...
                            <div style="padding: 30px; background: #fff;">
                                ...
                                <div style="margin-bottom: 30px;">
                                    ...
                                    <input type="text" id="phoneInput" class="bulk-input"
                                ...
                                <div style="margin-bottom: 40px;">
                                    ...
                                    <div class="bulk-rte">
                                        ...
                                        <div contenteditable="true" id="bioInput" class="rte-textarea"></div>
                                    </div>
                                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <label
                        ...
                        <input type="checkbox" id="bulkToggleCols" checked
                            style="accent-color: #d0021b; width: 16px; height: 16px;">
    ...
    <script>
        (function() {
            ...
            window._trash = function(id) {
                customConfirm('Are you sure you want to delete this member?', function() {
                    ajax('DELETE', ROUTES.destroy.replace('__ID__', id), null, function(err) {
                        ...
                        members = members.filter(r => r.id != id);
                        renderTable();
                        showToaster('Member deleted successfully.');
                    });
                });
            };
            ...
            window.openForm = function(id) {
                editingId = id;
                var item = id ? members.find(function(b) {
                    return b.id == id;
                }) : null;
                ...
                categories.forEach(function(c) {
                    catSel.innerHTML += '<option value="' + c.id + '"' + (item && item
                            .staff_member_category_id == c.id ? ' selected' : '') + '>' + c.name +
                        '</option>';
                });
            ...
            document.getElementById('saveBtn').onclick = function() {
                ...
                ajax(editingId ? 'PATCH' : 'POST', editingId ? ROUTES.update.replace('__ID__', editingId) : ROUTES
                    ...
                    function(err, res) {
                        if (err) return alert(err);
                        if (editingId) {
                            var idx = members.findIndex(function(b) {
                                return b.id == editingId;
                            });
                            if (idx > -1) members[idx] = res;
                        } else members.push(res);
                        window.location.hash = '#list';
                        renderTable();
                        showToaster('Member saved.');
                    });
            };
            ...
            function openBulkEdit() {
                ...
                if (members.length > 0) members.forEach(function(b) {
                    addBulkRow(b);
                });
