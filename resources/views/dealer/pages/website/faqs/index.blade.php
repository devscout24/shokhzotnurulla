        ...
        <div style="padding: 30px 45px 0 45px;">
            ...
            <div class="rc-wrapper">
                <div class="rc-sidebar">
                    <a href="{{ route('dealer.website.faqs.index') }}" class="rc-sidebar-item active"><i
                            class="bi bi-question-circle"></i> FAQs</a>
                    <a href="#" class="rc-sidebar-item"><i class="bi bi-megaphone"></i> OEM Promo Banners</a>
                    <a href="{{ route('dealer.website.srp-content.index') }}" class="rc-sidebar-item"><i
                            class="bi bi-file-earmark-text"></i> Content: Search Results (SRP)</a>
