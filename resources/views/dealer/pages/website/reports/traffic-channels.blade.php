...
@section('title', __('Traffic Channels Report') . ' | ' . __(config('app.name')))
        ...
        <div style="padding: 30px 45px;">
            <div class="report-header">
                ...
                <div class="report-controls">
                    <form action="{{ route('dealer.website.reports.traffic-channels') }}" method="GET" id="reportFilterForm">
                    ...
                    <a href="{{ route('dealer.website.reports.analytics.export', ['type' => 'traffic-channels', 'from' => $from, 'to' => $to]) }}" class="btn-export">
            ...
            <div class="rc-wrapper">
                ...
                <div class="rc-main-container">
                    <h3 class="report-table-title">{{ __('Traffic Channels') }}</h3>
                    ...
                    <table class="traffic-table">
                        ...
                        <tbody>
                            @forelse($stats as $s)
                                <tr>
                                    <td class="channel-value">{{ $s->value }}</td>
