            ...
            <div class="rc-wrapper">
                ...
                <div class="rc-main-container">
                    ...
                    <table class="analytics-table">
                        <thead>
                            <tr>
                                <th style="width: 60%;">{{ in_array($type, ['top-pages', 'top-entry-pages', 'top-exit-pages']) ? __('URL') : __('Value') }}</th>
                                <th style="width: 20%;">{{ in_array($type, ['top-pages', 'top-entry-pages', 'top-exit-pages']) ? __('Page Views') : __('Page Views') }}</th>
