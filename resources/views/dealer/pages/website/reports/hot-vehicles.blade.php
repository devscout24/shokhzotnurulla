...
@section('title', __('Hot Vehicles Report') . ' | ' . __(config('app.name')))
        ...
        <div style="padding: 30px 45px;">
            <div class="report-header">
                ...
                <div class="report-controls">
                    <form action="{{ route('dealer.website.reports.hot-vehicles') }}" method="GET" id="reportFilterForm">
                    ...
                    <a href="{{ route('dealer.website.reports.hot-vehicles.export', request()->all()) }}" class="btn-export">
            ...
            <div class="rc-wrapper">
                ...
                <div class="rc-main-container">
                    <h3 class="report-table-title">{{ __('Hot Vehicles') }}</h3>
