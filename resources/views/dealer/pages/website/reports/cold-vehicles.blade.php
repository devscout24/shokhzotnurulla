...
@section('title', __('Cold Vehicles Report') . ' | ' . __(config('app.name')))
        ...
        <div style="padding: 30px 45px;">
            <div class="report-header">
                ...
                <div class="report-controls">
                    <form action="{{ route('dealer.website.reports.cold-vehicles') }}" method="GET" id="reportFilterForm">
                    ...
                    <a href="{{ route('dealer.website.reports.cold-vehicles.export', request()->all()) }}" class="btn-export">
            ...
            <div class="rc-wrapper">
                ...
                <div class="rc-main-container">
                    <h3 class="report-table-title">{{ __('Cold Vehicles') }}</h3>
                    
                    <table class="cold-table">
                        <thead>
                            <tr>
                                <th style="width: 60%;">{{ __('Vehicle') }}</th>
                                <th style="width: 20%;">{{ __('Stock #') }}</th>
                                <th style="width: 20%;">{{ __('Popularity') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($vehicles as $vehicle)
                                <tr>
                                    <td class="vehicle-name">{{ $vehicle->display_title }}</td>
                                    <td>{{ $vehicle->stock_number }}</td>
                                    <td class="popularity-pct">{{ number_format($vehicle->popularity, 2) }}%</td>
                                </tr>
                            @empty
                                <tr>
