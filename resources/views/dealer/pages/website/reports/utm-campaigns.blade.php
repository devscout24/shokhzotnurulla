...
@section('title', __('UTM Campaigns Report') . ' | ' . __(config('app.name')))
        ...
        <div style="padding: 30px 45px;">
            <div class="report-header">
                ...
                <div class="report-controls">
                    <form action="{{ route('dealer.website.reports.utm-campaigns') }}" method="GET" id="reportFilterForm">
                    ...
                    <a href="{{ route('dealer.website.reports.analytics.export', ['type' => 'utm-campaigns', 'from' => $from, 'to' => $to]) }}" class="btn-export">
            ...
            <div class="rc-wrapper">
                ...
                <div class="rc-main-container">
                    <h3 class="report-table-title">{{ __('UTM Campaigns') }}</h3>
                    ...
                    <table class="traffic-table">
                        ...
                        <tbody>
                            @forelse($stats as $s)
                                <tr>
                                    <td class="campaign-value">{{ $s->value }}</td>
