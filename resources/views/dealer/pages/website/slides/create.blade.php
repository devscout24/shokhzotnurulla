    ...
    <div class="of-master-frame">
        <form action="{{ $routes['store'] }}" method="POST" id="page-builder-form" style="display:contents"
            ...
            <div class="of-header shadow-sm">
                <h4 class="fw-bold m-0 fs-5 text-dark">Add Slide</h4>
                ...
                <div class="side-panel-body">
                    ...
                    <div class="hs-row">
                        ...
                        <div class="d-flex gap-2">
                            <input class="hs-input" name="slug" id="page-slug" placeholder="my-slide">
                            <a href="#" target="_blank" id="slug-preview-link"
                                class="btn btn-outline-secondary d-flex align-items-center disabled" title="View Slide">
