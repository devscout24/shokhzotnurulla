...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (onsaleToggleBtn || onsaleBodyDiv) {
        onsaleToggleBtn.addEventListener('click', function () {
            if (onsaleBodyDiv.style.display === 'none') {
                onsaleBodyDiv.style.display = 'block';
                if (onsaleIconEl) {
                    onsaleIconEl.classList.remove('fa-square-plus');
                    onsaleIconEl.classList.add('fa-square-minus');
                }
            } else {
                onsaleBodyDiv.style.display = 'none';
                if (onsaleIconEl) {
                    onsaleIconEl.classList.remove('fa-square-minus');
                    onsaleIconEl.classList.add('fa-square-plus');
                }
            }
        });
    }
    ...
    if (locToggle && locBox) {
        locToggle.addEventListener('click', function () {
            ...
            if (locBox.style.display === 'none') {
                ...
                if (currentIcon) {
                    currentIcon.classList.remove('fa-square-plus');
                    currentIcon.classList.add('fa-square-minus');
                }
            } else {
                locBox.style.display = 'none';
                if (currentIcon) {
                    currentIcon.classList.remove('fa-square-minus');
                    currentIcon.classList.add('fa-square-plus');
                }
            }
        });
    }
...
/* ── On sale now! + Location toggles — MOBILE ── */
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (onsaleToggleMobile && onsaleBodyMobile) {
        onsaleToggleMobile.addEventListener('click', function () {
            if (onsaleBodyMobile.style.display === 'none') {
                onsaleBodyMobile.style.display = 'block';
                if (onsaleIconElMobile) {
                    onsaleIconElMobile.classList.remove('fa-square-plus');
                    onsaleIconElMobile.classList.add('fa-square-minus');
                }
            } else {
                onsaleBodyMobile.style.display = 'none';
                if (onsaleIconElMobile) {
                    onsaleIconElMobile.classList.remove('fa-square-minus');
                    onsaleIconElMobile.classList.add('fa-square-plus');
                }
            }
        });
    }
    ...
    if (locToggleMobile && locBoxMobile) {
        locToggleMobile.addEventListener('click', function () {
            ...
            if (locBoxMobile.style.display === 'none') {
                ...
                locBoxMobile.style.display = 'none';
                if (currentIcon) {
                    currentIcon.classList.remove('fa-square-minus');
                    currentIcon.classList.add('fa-square-plus');
                }
...
(function () {
    ...
    var mainPhoto = document.getElementById('vdpMainPhoto');
    if (!mainPhoto) return;

    document.addEventListener('click', function (e) {
        var thumb = e.target.closest('.vdp-thumb');
        if (!thumb) return;
        ...
        document.querySelectorAll('.vdp-thumb').forEach(function (t) {
            t.style.opacity = '0.7';
        });
