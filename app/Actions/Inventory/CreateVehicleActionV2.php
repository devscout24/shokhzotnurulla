    ...
    public function __invoke(Dealer $dealer, array $data): Vehicle
    {
        return DB::transaction(function () use ($dealer, $data) {
            ...
            VehicleSpec::create([
                ...
                'cylinders' => $data['engine_cylinders'] ?? $data['cylinders'] ?? null,
                'displacement' => $data['engine_displacement_l'] ?? $data['displacement'] ?? null,
                'max_horsepower' => $data['engine_hp'] ?? $data['max_horsepower'] ?? null,
                'max_horsepower_at' => $data['engine_hp_rpm'] ?? $data['max_horsepower_at'] ?? null,
                'max_torque' => $data['torque'] ?? $data['max_torque'] ?? null,
                'max_torque_at' => $data['torque_rpm'] ?? $data['max_torque_at'] ?? null,
