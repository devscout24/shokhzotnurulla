...
function open3ColSettings(el) {
  ...
  const gapInput = document.getElementById('col3-gap');
  ...
  block.innerHTML = `
    ...
    <div class="dropped-block-inner">
      <div class="editor-3col" style="display: flex; gap: 20px; width: 100%;">
        ...
        <div class="col-drop-zone flex-grow-1" style="min-height: 80px; border: 1px dashed #ced4da; border-radius: 4px; padding: 10px;">
          <p contenteditable="true" spellcheck="false" data-placeholder="Column 3" style="margin:0; color:#adb5bd; font-size:13px; min-height:20px; outline:none;"></p>
        </div>
      </div>
    </div>`;
